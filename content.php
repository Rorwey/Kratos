...
<div class="kratos-post-inner">
    <header class="kratos-entry-header clearfix">
        <h2 class="kratos-entry-title"><a href="<?php the_permalink() ?>"><?php the_title() ?></a><?php if(is_sticky()) echo __("—置顶","dmeng"); ?></h2>
        <div class="kratos-post-meta">
            ...
            <a href="<?php the_permalink() ?>#respond"><i class="fa fa-commenting-o"></i> <?php comments_number('0','1','%'); ?><?php _e('条评论 ','dmeng');?></a>
            </span>
            <span class="pull-left">
            <a href="<?php the_permalink() ?>"><i class="fa fa-eye"></i> <?php echo kratos_get_post_views(); ?><?php _e('次阅读 ','dmeng');?></a>
...
<div class="kratos-entry-border-new clearfix">
    ...
    <div class="kratos-post-meta-new">
        ...
        <span class="visible-lg visible-md visible-sm pull-left">
            <a href="<?php the_permalink() ?>"><i class="fa fa-eye"></i> <?php echo kratos_get_post_views(); ?><?php _e('次阅读 ','dmeng');?></a>
            <a href="<?php the_permalink() ?>"><i class="fa fa-thumbs-o-up"></i> <?php if(get_post_meta($post->ID,'love',true)) echo get_post_meta($post->ID,'love',true); else echo '0'; ?><?php _e('人点赞','dmeng');?></a>
            <a href="<?php the_permalink() ?>"><i class="fa fa-user"></i> <?php the_author(); ?></a>
        </span>
        <span class="pull-right">
            <a class="read-more" href="<?php the_permalink() ?>" title="<?php _e('阅读全文','dmeng');?>"><?php _e('阅读全文','dmeng');?> <i class="fa fa-chevron-circle-right"></i></a>
        </span>
    </div>
</div>
<?php } ?>
